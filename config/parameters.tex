...
% \renewcommand{\thesection}{\arabic{section}} % désactivé : on garde le préfixe de chapitre (4.1, 4.2, ...)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%% Packages requis par les papiers inclus dans les chapitres %%%%%%%%%%%
...
\usepackage{colortbl}
\usepackage{comment}
% \subfloat (sans légende) fourni en no-op pour compat. avec subfig
...
\hypersetup{
	...
	pdfstartview={FitV null}, % ouvre le PDF de façon à ce qu'il prenne la taille verticale de l'écran
