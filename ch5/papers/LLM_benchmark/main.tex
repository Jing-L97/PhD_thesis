...
\section{Limitations}
The supplied few-shot templates combine conversational demonstrations with explicit output-length instructions (Appendix~\ref{sec:prompts}). Differences from zero-shot prompting therefore reflect this combined change, and cannot isolate the effect of examples on length or complexity.
...
Prompt templates, fine-tuning details, and example generations are provided in Appendix~\ref{app:dialogue}.
