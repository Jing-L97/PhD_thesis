...
\section{Limitations}
The supplied few-shot templates combine conversational demonstrations with explicit output-length instructions (Appendix A). Differences from zero-shot prompting therefore reflect this combined change, and cannot isolate the effect of examples on length or complexity.
